...
class RegisterState {
  ...
  const RegisterState.emailProvided(String email)
      : this._(
            status: RegistrationStatus.emailProvided, email: email, error: '');

  const RegisterState.loading() : this._(status: RegistrationStatus.loading);
  const RegisterState.failed(String error)
      : this._(status: RegistrationStatus.failed, error: error);
  const RegisterState.succeeded()
      : this._(status: RegistrationStatus.succeeded, error: '');
}
